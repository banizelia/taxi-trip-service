...
public interface TripsRepository extends JpaRepository<Trip, Long> {
    @Query("SELECT t FROM Trip t " +
            ...
            "WHERE (t.pickupDatetime BETWEEN :pickupDateTimeFrom AND :pickupDateTimeTo) " +
    ...
    Page<Trip> filter(
            ...
            @Param("pickupDateTimeFrom") LocalDateTime pickupDateTimeFrom,
            @Param("pickupDateTimeTo") LocalDateTime pickupDateTimeTo,
