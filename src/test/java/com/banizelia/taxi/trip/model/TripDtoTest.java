...
class TripDtoTest {
    ...
    void testEquals() {
        ...
        tripDto1.setId(1L);
        tripDto2.setId(1L);
        tripDto1.setVendorId(1);
        tripDto2.setVendorId(1);
    ...
    void testCompleteDto() {
        ...
        assertAll(
                ...
                () -> assertEquals(1, tripDto.getVendorId()),
                () -> assertEquals(testDateTime, tripDto.getPickupDatetime()),
                ...
                () -> assertEquals(1, tripDto.getRateCodeId()),
                ...
                () -> assertEquals(1, tripDto.getPaymentType()),
