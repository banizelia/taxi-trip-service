...
class TripDtoTest {
    ...
    class GetterSetterTests {
        ...
        void testPickupDatetimeGetterSetter() {
            tripDto.setPickupDatetime(TEST_DATETIME);
            assertEquals(TEST_DATETIME, tripDto.getPickupDatetime());
        }

        @Test
        void testDropoffDatetimeGetterSetter() {
            tripDto.setDropoffDatetime(TEST_DATETIME);
            assertEquals(TEST_DATETIME, tripDto.getDropoffDatetime());
        }
    ...
    void testToString() {
        ...
        assertTrue(toString.contains("pickupDatetime=" + TEST_DATETIME));
    ...
    void testCompleteDto() {
        ...
        tripDto.setVendorId("V123");
        tripDto.setPickupDatetime(TEST_DATETIME);
        tripDto.setDropoffDatetime(TEST_DATETIME.plusHours(1));
        tripDto.setPassengerCount(2);
        ...
        assertAll(
                ...
                () -> assertEquals(TEST_DATETIME, tripDto.getPickupDatetime()),
                () -> assertEquals(TEST_DATETIME.plusHours(1), tripDto.getDropoffDatetime()),
