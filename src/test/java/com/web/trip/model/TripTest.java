...
class TripTest {
    ...
    class BasicFieldsTests {
        ...
        void testPickupDatetimeField() {
            ...
            assertEquals(TEST_DATETIME, trip.getPickupDatetime());
        }

        @Test
        void testDropoffDatetimeField() {
            trip.setDropoffDatetime(TEST_DATETIME);
            assertEquals(TEST_DATETIME, trip.getDropoffDatetime());
        }
    ...
    void testCompleteTrip() {
        ...
        assertAll(
                ...
                () -> assertEquals(TEST_DATETIME, trip.getPickupDatetime()),
                () -> assertEquals(TEST_DATETIME.plusHours(1), trip.getDropoffDatetime()),
                ...
                () -> assertEquals(TEST_DATE, trip.getPickupDate()),
                () -> assertNotNull(trip.getWeather()),
                () -> assertNotNull(trip.getFavoriteTrip())
        );
    }
